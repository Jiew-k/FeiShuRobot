...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "c8116f32";
    public static final String apiSecret = "ZmJjODEwNDRlZTUwZmNlYTQyNjVhMDg2";
    public static final String apiKey = "edb599c8a4bad61d176fc2543c6dde00";
    ...
    public void createWebSocket(String question) throws Exception {
        if (totalFlag) {
